...
public enum OrderErrorCode implements ErrorCodeSpec {
	...
	ORDER_INVALID_SUPPLIER("ORDER_009", HttpStatus.BAD_REQUEST, "현재 업체가 유효한 공급업체가 아닙니다."),
	ORDER_INVALID_RECEIVER("ORDER_010", HttpStatus.BAD_REQUEST, "현재 업체가 유효한 수령업체가 아닙니다."),
	ORDER_INVALID_COMPANY_TYPE("ORDER_011", HttpStatus.BAD_REQUEST, "현재 업체의 업체타입이 유효하지 않습니다."),
	ORDER_INVALID_ITEM("ORDER_012", HttpStatus.BAD_REQUEST, "주문할 상품을 제공하지 않는 업체입니다."),
	ORDER_INVALID_QUANTITY("ORDER_013", HttpStatus.BAD_REQUEST, "유효하지 않은 주문수량입니다."),
	ORDER_HUB_NOT_FOUND("ORDER_014", HttpStatus.BAD_REQUEST, "업체의 담당 허브 정보를 찾을 수 없습니다."),
	ORDER_ITEM_NOT_FOUND("ORDER_015", HttpStatus.NOT_FOUND, "주문할 상품을 찾을 수 없습니다."),
